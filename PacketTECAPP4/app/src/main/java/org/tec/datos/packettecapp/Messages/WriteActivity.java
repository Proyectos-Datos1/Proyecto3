...
import org.tec.datos.packettecapp.datastructures.LinkedList.SimpleList.SimpleList;
import org.tec.datos.packettecapp.objects.Message;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_account:
                intent = new Intent(WriteActivity.this, AccountActivity.class);
                Toast.makeText(WriteActivity.this,"Go to Account", Toast.LENGTH_SHORT).show();
                startActivity(intent);
                return true;
